...
- The stable stage distribution for stages 2-8 (ignoring seeds) is 0.00, 0.00, 0.00, 0.00, 0.46, 0.23, and 0.31, respectively.
...
The population seems to be growing by about 5% annually.

## (b) variance of lambda

The variance of the stochastic log lambda, which are estimated from the data and therefore this is a standard error of the estimate.
