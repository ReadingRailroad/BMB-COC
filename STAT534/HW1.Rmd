...
# resampling residuals maintaining rows including pairwise comparisons with a multiplicity adjustment
# reduce number of bootsraps
anova(fish.glm, pairwise.comp = habitat, nBoot = 499)

# which species differ between habitats?
fish.glm0<-manyglm(bci.mva ~ 1)
