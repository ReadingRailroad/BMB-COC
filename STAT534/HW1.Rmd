...
The test statistic is 0.461 with an associated p-value of 0.497, suggesting that there is no evidence to support the alternative 

## g)

Calculate a 95% _profile likelihood_ confidence interval for the difference in means. Note: this will require writing a function that enables finding the mle of one group's mean abundance and the shared overdispersion given a specified difference in means.
