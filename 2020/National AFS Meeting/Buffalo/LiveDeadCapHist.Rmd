...
levels(long.LD$Gear)
df=droplevels(subset(long.LD, Gear !="COMMERCIAL HARVEST")) # live encounters
ddf=droplevels(subset(long.LD, Gear == "COMMERCIAL HARVEST")) # dead recoveries
#create date intervals that are approximately every 6 months
intervals=as.Date("2017-04-01")+seq(30,15*365,182.5)
