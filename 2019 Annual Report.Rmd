...
mod<-lm(Mean ~ BMD + Year, data = DF.17.18)
summary(mod)
R2<-format(summary(mod)$r.squared,digits=3)

max(DF.17.18$U.BMD)
max(DF.17.18$Trad.upper)
...
packages("ggpmisc")
CPUE.Plot<-ggplot(DF.17.18, aes(x=BMD, y=Mean, label = Lake)) +
                            geom_point(size=2) +
...
=======
<<<<<<< HEAD
svTypical<-list(Linf=1000,K=0.0243,t0=-4.49032)
=======
svTypical<-list(Linf=560,K=0.02430846,t0=-31.50717871)
>>>>>>> 3e664d588fb6f006ffae7870b99549ad5fc96c75
>>>>>>> 979d699f6387675f608f23000a946113bd90bbfb
...
fitTypical <- nls(vbTypical,data=b.carp,start=svTypical) ## Error as well
#overview(fitTypical)
...
# subset by species then separate by lake
        #buff
buff <- subset(ages, Species == "COC")
summary(buff)
packages("ggplot2")
ggplot(ages, aes(x=Otolith.MAS, y=Otolith.DRF, shape = Lake, colour = Lake))+geom_point(size=5)+
...
bm<-ggplot(frame, aes(x= Year, y = BM, ymin=L.BM, ymax=U.BM))+
                ...
                theme(panel.grid.major = element_blank(), 
                      ...
                      axis.line = element_line(colour = "black"),
                      legend.position = "none")+
                labs (title = "Change in Total Biomass 2017-2018", 
...
bmD<-ggplot(frame, aes(x= Year, y = BMDensity, ymin=L.BMDensity, ymax=U.BMDensity))+
                ...
                theme(panel.grid.major = element_blank(), 
                      ...
                      axis.line = element_line(colour = "black"),
                      legend.position = "none")+
                labs (title = "Change in Biomass Density 2017-2018", 
...
# reduce "Diversity" to top 6 interesting species
# WAE, BLG, LMB, CCF, WHC, BLC
str(diversity)
