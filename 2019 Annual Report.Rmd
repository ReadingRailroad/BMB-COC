...
DF.boxplot<-ggplot(DF, aes(x=Month, y=cpue))+
  geom_boxplot(aes(fill = Lake, colour = Lake),
              size=1)+
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.background = element_rect(fill="white",colour="grey50"), 
...
BMD.plot2<-ggplot(DF2018, aes(x= BMD,y=Mean))+
...
Age.Hist<-ggplot(ages, aes(x=Spine.MAS, fill = Species))+
                         geom_histogram(binwidth = 1,
                                        colour = "black",
                                        position = "stack")+
                         facet_grid(.~Lake)+
                         theme(panel.grid.major = element_blank(), 
                              ...
                              legend.background = element_rect(colour="grey20"))+
                         scale_fill_grey(start = 0.1, end = 0.9, aesthetics = "fill")+
                         labs(title = "2017 Age Frequency Histograms",
                              x = "Year",
                              y = "Frequency")
