...
st.buff$age<-st.buff$Spine.DRF # No otoliths taken from this lake 2017
...
#svAlternate<-vbStartsDP(TL.mm,Otolith.MAS,data=b.buff)
unlist(svTypical)
svTypical<-list(Linf=632.94,K=0.3592972,t0=-0.9764594) # screwed up starting values... try spines
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(632.94,0.3592972,-0.9764594))
