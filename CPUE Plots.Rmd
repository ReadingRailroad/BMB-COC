...
cpue2<-groupwiseMean(cpue~Season + Lake + Species + Site.Transect, cpue, mean)


df.efish.m<-melt(cpue2)
efish.cpue.cast<-dcast(df.efish.m, 
                       Lake + Season + Site.Transect ~ Species, 
...
write.csv(cpue, "2019 Raw CPUE Data.csv", row.names = F)
```
