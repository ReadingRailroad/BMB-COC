...
<<<<<<< HEAD
__New 12-13-2018: importing "All.Biomass", the length-specific biomass and biomass density estimates from 2018__
```{r,}

all.bm<-read.csv("2018_BiomassDensityEstimates.csv")

# CarpCPUE - n fish per hour electrofishing
# think i need to melt and cast here, let's try for just carp

coc.df<-subset(df, Species == "COC")
coc.df.melt<-melt(coc.df, id = c("Lake","Date","Site.Transect"))
...
str(coc.df)
>>>>>>> cf323e8be194eb2cc159ed13594c256f372f38e4
