...
# melt and cast to get total count of fish by species in each run
library(reshape2)
stdRuns.melt<-melt(stdRuns, id.vars = c("Date","Lake","Transect"))

CPUE<-dcast(stdRuns.melt, Date+Lake+Transect~variable)
```
