...
#
#       Found 12-18-2018
#       6/18/18 N Twin transects without transect #
data$Site.Transect[data$TAG.NUMBER == 13905|13921|13920|13919|13918|13917|13916|13915|13914|13913|13912|13911|
                                       13906|13907|13908|13909|13910|16801|16082|16803|16804|16805|16806|16807|
                                       16808|16809|16810|16854&
                     data$Date == "2015-06-18"] <- "1"
data$Site.Transect[data$TAG.NUMBER == 16855|16856|16857|16858|16859|16860|16861|16862|16863|16864&
                     data$Date == "2015-06-18"] <- "2"
data$Site.Transect[data$TAG.NUMBER == 16879|16880|16881|16883|16884|16885|16886|16887|16888|16889|16890|16891|
                                      16892|16893|16894|16895|16896|16897|16899|16900|16851|16852|16853|5111|1401 &
                     data$Date == "2015-06-18"] <- "3"
data$Site.Transect[data$TAG.NUMBER == 16811&
                     data$Date == "2015-06-18"] <-"4"
data$Site.Transect[data$TAG.NUMBER == 16812|16813|16814|16815|16816|16817|16818|16819|16820|16821|16822|16823|
                                      16824|16825|16826|16827|16828|16829|16830|16831|16832|16833|16834|16835|
                                      16836|16837|16838|16839|16840|16841|16842|16843|16844|16845|16846|16847|
                                      16848|16849|16850|16876|16877|16878 &
                     data$Date == "2015-06-18"] <-"5"
############################################################################
...
data$On.Time..s.
# check tag 18499 and 19026: gear listed as seine but sites given std transect names, but also seine on that day 5/22/18 five island
...
# then all blanks (5423 of them) can become NAs because they come from either seines or fykes
...
#
 write.csv(data, "2018_COC_BIB_CMR_Data.csv")
...
blue.df <- read.csv("C:\\Users/M_Sim/OneDrive/IOWA/Iowa State University/CarpR/BlueLake/2017 BL Carp Tag Data.csv")
str(blue.df)
...
# looks good, except why are there more NAs when subset to only carp?
# probably syntax stuff or that droplevels crap above.
...
__Twin Lakes__
```{r}
twin.df <- read.csv("C:\\Users/M_Sim/OneDrive/IOWA/Iowa State University/CarpR/TwinLakes/2017 TwinLakes Tag Data.csv", header = TRUE)
str(twin.df)
...
# dang that's some nice work. Up to 20k observations
```
...
```{r}
center.df <- read.csv("C:\\Users/M_Sim/OneDrive/IOWA/Iowa State University/CarpR/CenterLake/2017 CenterLake Tag Data.csv", header = TRUE)
str(center.df)
...
Holy cow! As of 12/11/2018 this data frame is now 22k observations long. Time to celebrate with more data checking. for now let's write a new csv in a new chunk to have the 2017 and 2018 data separate from the other 2018 only data
