...
Data used will be "2019 Tagging Data.csv"
...
data<-read.csv("2019 Tagging Data.csv", header = T)
str(data)
data$Length..mm.<-as.numeric(as.character(data$Length..mm.))
summary(data$Length..mm.)
data$Weight..g.<-as.numeric(as.character(data$Weight..g.))
...
Blue.coc$Length..mm.[Blue.coc$Length..mm. == 0] <- NA
...
# 
# Blue Population Estimates: 13588 - 25294 - 36999
...
Blue.COC.50$LowerBM<-Blue.COC.50$percent * Blue.COC.50$mweight * 13588 # multiply fraction, mean weight, lower pop.
C.L.BM<-sum(Blue.COC.50$LowerBM/453.592)


Blue.COC.50$BMest<-Blue.COC.50$percent * Blue.COC.50$mweight * 25294 # multiply fraction, mean weight, pop. est
C.BM<-sum(Blue.COC.50$BMest/453.592)

Blue.COC.50$UpperBM<-Blue.COC.50$percent * Blue.COC.50$mweight * 36999 # multiply fraction, mean weight, upper pop.
...
# Calculate the total weight through a sum of fractional weights
# 
# Center Carp Population Estimates: 372 - 1451 - 2531
...
Center.COC.50$BMest<-Center.COC.50$percent * Center.COC.50$mweight * 1451 # multiply fraction, mean weight, pop. est
...
FiveIsland.COC.50$mweight<-c(w2,w2,w5,w5,w6,w7,w8,w9,w10,w11,w12) 
...
FiveIsland.bib.50$mweight<-c(w2,w3,w5,w6,w7,w8,w9) 
...
# Calculate the total weight through a sum of fractional weights
# 
# FiveIsland Carp Population Estimates: 0 - 29860 - 62378
# FiveIsland Buff Population Estimates: 0 - 311 - 2140
...
FiveIsland.COC.50$LowerBM<-FiveIsland.COC.50$percent * FiveIsland.COC.50$mweight * 0 # multiply fraction, mean weight, lower pop.
C.L.BM<-sum(FiveIsland.COC.50$LowerBM/453.592)


FiveIsland.COC.50$BMest<-FiveIsland.COC.50$percent * FiveIsland.COC.50$mweight * 29860 # multiply fraction, mean weight, pop. est
C.BM<-sum(FiveIsland.COC.50$BMest/453.592)

FiveIsland.COC.50$UpperBM<-FiveIsland.COC.50$percent * FiveIsland.COC.50$mweight * 62378 # multiply fraction, mean weight, upper pop.
...
FiveIsland.bib.50$BMest<-FiveIsland.bib.50$percent * FiveIsland.bib.50$mweight * 311 # multiply fraction, mean weight, pop. est
B.BM<-sum(FiveIsland.bib.50$BMest/453.592)

FiveIsland.bib.50$UpperBM<-FiveIsland.bib.50$percent * FiveIsland.bib.50$mweight * 2140 # multiply fraction, mean weight, upper pop.
...
NTwin.COC.50$mweight<-c(w7,w7,w8,w9,w10,w11,w12,w13,w13)
...
NTwin.bib.temp<-subset(NTwin.bib, Length..mm. >= 0 & Length..mm. < 50 & !is.na(Weight..g.))
...
NTwin.bib.50$mweight<-c(w6,w6,w6,w6,w7,w8,w9,w10,w11,w12,w13,w14) 

#######
#
# Calculate the total weight through a sum of fractional weights
# 
# NTwin Carp Population Estimates: 842 - 2447 - 4052
# NTwin Buff Population Estimates: 351 - 17527 - 34704
...
NTwin.COC.50$LowerBM<-NTwin.COC.50$percent * NTwin.COC.50$mweight * 842 # multiply fraction, mean weight, lower pop.
C.L.BM<-sum(NTwin.COC.50$LowerBM/453.592)


NTwin.COC.50$BMest<-NTwin.COC.50$percent * NTwin.COC.50$mweight * 2447 # multiply fraction, mean weight, pop. est
C.BM<-sum(NTwin.COC.50$BMest/453.592)

NTwin.COC.50$UpperBM<-NTwin.COC.50$percent * NTwin.COC.50$mweight * 4052 # multiply fraction, mean weight, upper pop.
...
NTwin.bib.50$LowerBM<-NTwin.bib.50$percent * NTwin.bib.50$mweight * 351 # multiply fraction, mean weight, lower pop.
B.L.BM<-sum(NTwin.bib.50$LowerBM/453.592)

NTwin.bib.50$BMest<-NTwin.bib.50$percent * NTwin.bib.50$mweight * 17527 # multiply fraction, mean weight, pop. est
B.BM<-sum(NTwin.bib.50$BMest/453.592)

NTwin.bib.50$UpperBM<-NTwin.bib.50$percent * NTwin.bib.50$mweight * 34704 # multiply fraction, mean weight, upper pop.
...
Silver.bib.50$mweight<-c(w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12) 
...
STwin.COC.50$mweight<-c(w000,w000,w1,w1,w2,w3,w4,w5,w7,w7,w7)
...
STwin.bib.50$mweight<-c(w0,w3,w3,w4,w5,w6,w7,w8) 

#######
#
# Calculate the total weight through a sum of fractional weights
# 
# STwin Carp Population Estimates: 6207 - 16419 - 26630
# STwin Buff Population Estimates: 0 - 8496 - 30523
...
STwin.COC.50$LowerBM<-STwin.COC.50$percent * STwin.COC.50$mweight * 6207 # multiply fraction, mean weight, lower pop.
C.L.BM<-sum(STwin.COC.50$LowerBM/453.592)


STwin.COC.50$BMest<-STwin.COC.50$percent * STwin.COC.50$mweight * 16419 # multiply fraction, mean weight, pop. est
C.BM<-sum(STwin.COC.50$BMest/453.592)

STwin.COC.50$UpperBM<-STwin.COC.50$percent * STwin.COC.50$mweight * 26630 # multiply fraction, mean weight, upper pop.
...
STwin.bib.50$BMest<-STwin.bib.50$percent * STwin.bib.50$mweight * 8496 # multiply fraction, mean weight, pop. est
B.BM<-sum(STwin.bib.50$BMest/453.592)

STwin.bib.50$UpperBM<-STwin.bib.50$percent * STwin.bib.50$mweight * 30523 # multiply fraction, mean weight, upper pop.
...
All.biomass<-rbind(Blue.BM.Density,
                   ...
                   STwin.BM.Density,
                   Storm.BM.Density)
All.biomass<-cbind(Lake,All.biomass)
