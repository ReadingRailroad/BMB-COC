...
This document is augmented from the 2018 length-specific weight markdown file.

Data used will be "2017-2020 Compiled Data.csv" but only for 2019

# length-specific biomass estimates
Clean up data

subset by lakes after
...
# subset for 2019 only
data<-droplevels(subset(data, Year == "2019"))
#Lakes
levels(data$Lake)
...
Blue.COC.25 <- Blue.coc %>%
  ...
  group_by(Species, n, gr=cut(Length..mm., breaks = seq(0,1000,by=25))) %>%
  summarise(n = n()) %>%
...
w0<-mean(Blue.coc.temp$Weight..g.)
...
Blue.coc.temp<-subset(Blue.coc, Length..mm. >= 700 & Length..mm. < 750 & !is.na(Weight..g.))
w10<-mean(Blue.coc.temp$Weight..g.)

Blue.COC.50$mweight<-c(w2,w2,w2,w3,w4,w5,w6,w7,w8,w9) 
#######
#
# Calculate the total weight through a sum of fractional weights
# 
# Blue Population Estimates: 13786 - 25661 - 37537
...
Blue.COC.50$LowerBM<-Blue.COC.50$percent * Blue.COC.50$mweight * 13786 # multiply fraction, mean weight, lower pop.
C.L.BM<-sum(Blue.COC.50$LowerBM/453.592)


Blue.COC.50$BMest<-Blue.COC.50$percent * Blue.COC.50$mweight * 25661 # multiply fraction, mean weight, pop. est
C.BM<-sum(Blue.COC.50$BMest/453.592)

Blue.COC.50$UpperBM<-Blue.COC.50$percent * Blue.COC.50$mweight * 37537 # multiply fraction, mean weight, upper pop.
...
Center.COC.50$mweight<-c(w4,w4,w5,w6,w7,w8,w9,w10,w11,w12) 
...
Center.bib.50$mweight<-c(w1,w2,w3,w4,w5,w6,w7,w8) 

#######
#
# Calculate the total weight through a sum of fractional weights
# 
# Center Carp Population Estimates: 372 - 1452 - 2531
# Center Buff Population Estimates: 0 - 3840 - 13796
...
Center.COC.50$LowerBM<-Center.COC.50$percent * Center.COC.50$mweight * 372 # multiply fraction, mean weight, lower pop.
C.L.BM<-sum(Center.COC.50$LowerBM/453.592)


Center.COC.50$BMest<-Center.COC.50$percent * Center.COC.50$mweight * 1452 # multiply fraction, mean weight, pop. est
C.BM<-sum(Center.COC.50$BMest/453.592)

Center.COC.50$UpperBM<-Center.COC.50$percent * Center.COC.50$mweight * 2531 # multiply fraction, mean weight, upper pop.
...
Center.bib.50$LowerBM<-Center.bib.50$percent * Center.bib.50$mweight * 0 # multiply fraction, mean weight, lower pop.
B.L.BM<-sum(Center.bib.50$LowerBM/453.592)

Center.bib.50$BMest<-Center.bib.50$percent * Center.bib.50$mweight * 3840 # multiply fraction, mean weight, pop. est
B.BM<-sum(Center.bib.50$BMest/453.592)

Center.bib.50$UpperBM<-Center.bib.50$percent * Center.bib.50$mweight * 13796 # multiply fraction, mean weight, upper pop.
...
FiveIsland.COC.50$mweight<-c(w2,w2,w5,w5,w6,w7,w8,w9,w10,w11,w12,w12) 
...
FiveIsland.bib.temp<-subset(FiveIsland.bib, Length..mm. >= 250 & Length..mm. < 300 & !is.na(Weight..g.))
w1<-mean(FiveIsland.bib.temp$Weight..g.)
...
FiveIsland.bib.50$mweight<-c(w1,w1,w3,w4,w5,w6,w7,w8,w9,w10) 
...
# Calculate the total weight through a sum of fractional weights
# 
# FiveIsland Carp Population Estimates: 6794 - 19739 - 32683
# FiveIsland Buff Population Estimates: 0 - 1303 - 8965
...
FiveIsland.COC.50$LowerBM<-FiveIsland.COC.50$percent * FiveIsland.COC.50$mweight * 6794 # multiply fraction, mean weight, lower pop.
C.L.BM<-sum(FiveIsland.COC.50$LowerBM/453.592)


FiveIsland.COC.50$BMest<-FiveIsland.COC.50$percent * FiveIsland.COC.50$mweight * 19739 # multiply fraction, mean weight, pop. est
C.BM<-sum(FiveIsland.COC.50$BMest/453.592)

FiveIsland.COC.50$UpperBM<-FiveIsland.COC.50$percent * FiveIsland.COC.50$mweight * 32683 # multiply fraction, mean weight, upper pop.
...
FiveIsland.bib.50$LowerBM<-FiveIsland.bib.50$percent * FiveIsland.bib.50$mweight * 0 # multiply fraction, mean weight, lower pop.
B.L.BM<-sum(FiveIsland.bib.50$LowerBM/453.592)

FiveIsland.bib.50$BMest<-FiveIsland.bib.50$percent * FiveIsland.bib.50$mweight * 1303 # multiply fraction, mean weight, pop. est
B.BM<-sum(FiveIsland.bib.50$BMest/453.592)

FiveIsland.bib.50$UpperBM<-FiveIsland.bib.50$percent * FiveIsland.bib.50$mweight * 8965 # multiply fraction, mean weight, upper pop.
...
NTwin.coc.temp<-subset(NTwin.coc, Length..mm. >= 900 & Length..mm. < 950 & !is.na(Weight..g.))
w11<-mean(NTwin.coc.temp$Weight..g.)


NTwin.COC.50$mweight<-c(w1,w2,w3,w4,w5,w6,w7,w8,w10,w10,w10)
...
w0<-mean(NTwin.bib.temp$Weight..g.)
...
NTwin.bib.50$mweight<-c(w2,w2,w2,w2,w5,w5,w6,w7,w8,w9,w10,w11,w12,w13) 

#######
#
# Calculate the total weight through a sum of fractional weights
# 
# NTwin Carp Population Estimates: 1511 - 2487 - 3464
# NTwin Buff Population Estimates: 14644 - 20424 - 26203
...
NTwin.COC.50$LowerBM<-NTwin.COC.50$percent * NTwin.COC.50$mweight * 1511 # multiply fraction, mean weight, lower pop.
C.L.BM<-sum(NTwin.COC.50$LowerBM/453.592)


NTwin.COC.50$BMest<-NTwin.COC.50$percent * NTwin.COC.50$mweight * 2487 # multiply fraction, mean weight, pop. est
C.BM<-sum(NTwin.COC.50$BMest/453.592)

NTwin.COC.50$UpperBM<-NTwin.COC.50$percent * NTwin.COC.50$mweight * 3464 # multiply fraction, mean weight, upper pop.
...
NTwin.bib.50$LowerBM<-NTwin.bib.50$percent * NTwin.bib.50$mweight * 14644 # multiply fraction, mean weight, lower pop.
B.L.BM<-sum(NTwin.bib.50$LowerBM/453.592)

NTwin.bib.50$BMest<-NTwin.bib.50$percent * NTwin.bib.50$mweight * 20424 # multiply fraction, mean weight, pop. est
B.BM<-sum(NTwin.bib.50$BMest/453.592)

NTwin.bib.50$UpperBM<-NTwin.bib.50$percent * NTwin.bib.50$mweight * 26203 # multiply fraction, mean weight, upper pop.
...
# Hypothetical junk to see what biomass estimates would be if we had more recaps
```{r}

NTwin.bib.50$BMest<-NTwin.bib.50$percent * NTwin.bib.50$mweight * 13500 # multiply fraction, mean weight, pop. est
B.BM<-sum(NTwin.bib.50$BMest/453.592)
...
w0<-mean(Silver.coc.temp$Weight..g.)

Silver.coc.temp<-subset(Silver.coc, Length..mm. >= 200 & Length..mm. < 250 & !is.na(Weight..g.))
...
Silver.COC.50$mweight<-c(w2,w2,w2,w6,w7,w8,w9,w10,w11,w12,w13,w14)
...
Silver.bib.temp<-subset(Silver.bib, Length..mm. >= 150 & Length..mm. < 200 & !is.na(Weight..g.))
...
Silver.bib.50$mweight<-c(w2,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12) 

#######
#
# Calculate the total weight through a sum of fractional weights
# 
# Silver Carp Population Estimates: 4521 - 9175 - 13828
# Silver Buff Population Estimates: 0 - 3767 - 25917
...
Silver.COC.50$LowerBM<-Silver.COC.50$percent * Silver.COC.50$mweight * 4521 # multiply fraction, mean weight, lower pop.
C.L.BM<-sum(Silver.COC.50$LowerBM/453.592)


Silver.COC.50$BMest<-Silver.COC.50$percent * Silver.COC.50$mweight * 9175 # multiply fraction, mean weight, pop. est
C.BM<-sum(Silver.COC.50$BMest/453.592)

Silver.COC.50$UpperBM<-Silver.COC.50$percent * Silver.COC.50$mweight * 13828 # multiply fraction, mean weight, upper pop.
...
Silver.bib.50$LowerBM<-Silver.bib.50$percent * Silver.bib.50$mweight * 0 # multiply fraction, mean weight, lower pop.
B.L.BM<-sum(Silver.bib.50$LowerBM/453.592)

Silver.bib.50$BMest<-Silver.bib.50$percent * Silver.bib.50$mweight * 3767 # multiply fraction, mean weight, pop. est
B.BM<-sum(Silver.bib.50$BMest/453.592)

Silver.bib.50$UpperBM<-Silver.bib.50$percent * Silver.bib.50$mweight * 25917 # multiply fraction, mean weight, upper pop.
B.U.BM<-sum(Silver.bib.50$UpperBM/453.592)

B.L.BMDensity<-B.L.BM/1041
B.BMDensity<-B.BM/1041
...
STwin.coc.temp<-subset(STwin.coc, Length..mm. >= 100 & Length..mm. < 150 & !is.na(Weight..g.))
w000<-mean(STwin.coc.temp$Weight..g.)

STwin.coc.temp<-subset(STwin.coc, Length..mm. >= 150 & Length..mm. < 200 & !is.na(Weight..g.))
w00<-mean(STwin.coc.temp$Weight..g.)

STwin.coc.temp<-subset(STwin.coc, Length..mm. >= 200 & Length..mm. < 250 & !is.na(Weight..g.))
w0<-mean(STwin.coc.temp$Weight..g.)
...
STwin.COC.50$mweight<-c(w000,w00,w0,w1,w2,w3,w4,w5,w6,w7,w7)
...
#STwin.bib.temp<-subset(STwin.bib, Length..mm. >= 0 & Length..mm. < 50 & !is.na(Weight..g.))
#w0<-mean(STwin.bib.temp$Weight..g.)
...
STwin.bib.50$mweight<-c(w3,w3,w3,w4,w5,w6,w7,w8,w9) 

#######
#
# Calculate the total weight through a sum of fractional weights
# 
# STwin Carp Population Estimates: 6443 - 14896 - 23349
# STwin Buff Population Estimates: 0 - 11649 - 31784
...
STwin.COC.50$LowerBM<-STwin.COC.50$percent * STwin.COC.50$mweight * 6443 # multiply fraction, mean weight, lower pop.
C.L.BM<-sum(STwin.COC.50$LowerBM/453.592)


STwin.COC.50$BMest<-STwin.COC.50$percent * STwin.COC.50$mweight * 14896 # multiply fraction, mean weight, pop. est
C.BM<-sum(STwin.COC.50$BMest/453.592)

STwin.COC.50$UpperBM<-STwin.COC.50$percent * STwin.COC.50$mweight * 23349 # multiply fraction, mean weight, upper pop.
...
STwin.bib.50$LowerBM<-STwin.bib.50$percent * STwin.bib.50$mweight * 0 # multiply fraction, mean weight, lower pop.
B.L.BM<-sum(STwin.bib.50$LowerBM/453.592)

STwin.bib.50$BMest<-STwin.bib.50$percent * STwin.bib.50$mweight * 11649 # multiply fraction, mean weight, pop. est
B.BM<-sum(STwin.bib.50$BMest/453.592)

STwin.bib.50$UpperBM<-STwin.bib.50$percent * STwin.bib.50$mweight * 31784 # multiply fraction, mean weight, upper pop.
...
Storm.COC.50$mweight<-c(w3,w3,w3,w4,w5,w6,w7,w8,w8,w8,w8)
...
Storm.bib.50$mweight<-c(w1,w3,w3,w5,w6,w6,w8,w8) 

#######
#
# Calculate the total weight through a sum of fractional weights
# 
# Storm Carp Population Estimates: 7873 - 15468 - 23063
# Storm Buff Population Estimates: 0 - 158 - 1087
...
Storm.COC.50$LowerBM<-Storm.COC.50$percent * Storm.COC.50$mweight * 7873 # multiply fraction, mean weight, lower pop.
C.L.BM<-sum(Storm.COC.50$LowerBM/453.592)


Storm.COC.50$BMest<-Storm.COC.50$percent * Storm.COC.50$mweight * 15468 # multiply fraction, mean weight, pop. est
C.BM<-sum(Storm.COC.50$BMest/453.592)

Storm.COC.50$UpperBM<-Storm.COC.50$percent * Storm.COC.50$mweight * 23063 # multiply fraction, mean weight, upper pop.
...
Storm.bib.50$LowerBM<-Storm.bib.50$percent * Storm.bib.50$mweight * 0 # multiply fraction, mean weight, lower pop.
B.L.BM<-sum(Storm.bib.50$LowerBM/453.592)

Storm.bib.50$BMest<-Storm.bib.50$percent * Storm.bib.50$mweight * 158 # multiply fraction, mean weight, pop. est
B.BM<-sum(Storm.bib.50$BMest/453.592)

Storm.bib.50$UpperBM<-Storm.bib.50$percent * Storm.bib.50$mweight * 1087 # multiply fraction, mean weight, upper pop.
...
Lake<-factor(c("Blue","Center","Five Island","N Twin","Silver","S Twin","Storm"))
Year<-factor(rep("2019",7))
...
write.csv(All.biomass,"2019_BiomassDensityEstimates.csv")
