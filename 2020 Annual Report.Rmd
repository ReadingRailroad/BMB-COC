...
svTypical<-vbStarts(tl~age,data=b.carp)
unlist(svTypical)
svTypical<-list(Linf=426.6693927,K=1.4285567,t0=0.7846017)
...
#svAlternate<-vbStartsDP(TL.mm,Otolith.MAS,data=b.carp)
unlist(svTypical)
svTypical<-list(Linf=676.5430337,K=0.2442079,t0=-4.2210478)
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(676,0.2442079,-4.2210478))
...
#svAlternate<-vbStartsDP(TL.mm,Otolith.MAS,data=b.carp)
unlist(svTypical)
svTypical<-list(Linf=679.8183989,K=0.6044431,t0=1.8686500)
...
# Plots
plot() # create the blank space, baby (I'll write your name)
...
#svAlternate<-vbStartsDP(TL.mm,Otolith.MAS,data=b.carp)
unlist(svTypical)
svTypical<-list(Linf=674.5,K=0.1976556,t0=-2.5083403)
...
#svAlternate<-vbStartsDP(TL.mm,Otolith.MAS,data=b.carp)
unlist(svTypical)
svTypical<-list(Linf=777.7,K=0.1713801,t0=-3.4099646)
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(777.7,0.1713801,-3.4099646))
...
unlist(svTypical)
svTypical<-list(Linf=745.515,K=0.69435,t0=0.7152428)
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(745.515,0.69435,0.7152428))
...
unlist(svTypical)
svTypical<-list(Linf=389.5,K=1.2754392,t0=0.1468164)
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(389.5,1.2754392,0.1468164))
...
unlist(svTypical)
svTypical<-list(Linf=502.182,K=0.540008,t0=-1.838716)
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(502.182,0.540008,-1.838716))
...
#svAlternate<-vbStartsDP(TL.mm,Otolith.MAS,data=b.buff)
unlist(svTypical)
svTypical<-list(Linf=585,K=0.2932983,t0=-3.2984356)
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(585,0.2932983,-3.2984356))
...
#svAlternate<-vbStartsDP(TL.mm,Otolith.MAS,data=b.buff)
unlist(svTypical)
svTypical<-list(Linf=674.9123,K=0.4222550,t0=-0.4462011)
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(674.9123,0.4222550,-0.4462011))
...
#svAlternate<-vbStartsDP(TL.mm,Otolith.MAS,data=b.buff)
unlist(svTypical)
svTypical<-list(Linf=737.4488,K=0.2088784,t0=-6.2929390)
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(737.4488,0.2088784,-6.2929390))
...
#svAlternate<-vbStartsDP(TL.mm,Otolith.MAS,data=b.buff)
unlist(svTypical)
svTypical<-list(Linf=887.5229,K=0.1701503,t0=-1.5694065)
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(887.5229,0.1701503,-1.5694065))
...
st.buff$mean.age<-rowMeans(st.buff[,6:13],na.rm=T)
st.buff$age<-st.buff$Spine.PVG
summary(st.buff$tl)
summary(st.buff$age)
summary(st.buff$mean.age)
#plot(tl~mean.age,st.buff2)


# vbStarts and function variables ****** problems converging ******
svTypical<-vbStarts(tl~mean.age,data=st.buff)
...
#write.csv(second.table, "2019_PSD_Sportfish.csv")
...
#write.csv(third.table, "2019_PSD_Sportfish2.csv")
