...
st.buff$age<-st.buff$Spine.MAS

summary(st.buff$tl)
summary(st.buff$age)

# vbStarts and function variables
svTypical<-vbStarts(tl~age,data=st.buff, methLinf = "oldAge",num4Linf = 2)
#svAlternate<-vbStartsDP(TL.mm,Otolith.MAS,data=b.buff)
unlist(svTypical)
svTypical<-list(Linf=721.36,K=0.3,t0=5.6592866)
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(647.7,0.1976491,-5.1246437))
