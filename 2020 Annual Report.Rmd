...
# Tag Number
str(dat.frame$TAG.NUMBER) # factor OK here
...
summary(dat.frame$Length..mm.) # not terrible. Lots of all-species runs with over 300 fish left many fish without length measurements. (DNR)
...
# detect: just 1 because it is an observation. sum/average these in later analyses
