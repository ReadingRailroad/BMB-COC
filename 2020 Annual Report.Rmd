...
b.carp$age<-as.numeric(b.carp$Marcus.Age..Spine.)
...
svTypical<-vbStarts(tl~age,data=b.carp,
                    ...
                    num4Linf = 5)
unlist(svTypical)
svTypical<-list(Linf=467.4772727,K=0.1115574,t0=-11.7962936)
...
# checking foli ages
nt.carp$Foli.Age..Spine.<-as.numeric(nt.carp$Foli.Age..Spine.)
summary(nt.carp$Foli.Age..Spine.)
summary(nt.carp$tl)
summary(nt.carp$age)
...
st.carp$age<-as.numeric(st.carp$Foli.Age..Spine.) # spines
...
#svAlternate<-vbStartsDP(TL.mm,Otolith.MAS,data=b.carp)
unlist(svTypical)
svTypical<-list(Linf=610,K=0.1329682,t0=-8.6968473)
...
vbTypical <- tl ~ Linf*(1-exp(-K*(age-t0)))
vbTyp<-vbFuns()
vbTyp(3,Linf=c(610,0.1329682,-8.6968473))
